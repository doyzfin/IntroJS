...
let nilaibahasaIng =98
let nilaiIpa  =90
const nilaiRata = nilaiMTK/4 + nilaibahasaIndo/4 + nilaibahasaIng/4 + nilaiIpa/4 ;

if (nilaiMTK && nilaibahasaIndo && nilaibahasaIng && nilaiIpa !== 'undefined'){
    if (nilaiRata > 100){
